...
void ReceivePacket(Ptr<Socket> socket)
{
    ...
    while (pkt = socket->RecvFrom(from))
    {
        ...
        NS_LOG_UNCOND(time << "s\t" << ipReceiver << "    " << socket->GetNode()->GetId() << "    uid: " << UID << "    from: " << ipSender << "    to: " << destinationAddress);
...
int main(int argc, char *argv[])
{
    ...
    - Delivery percentage:  52.518%
    - Total BytesSent:      1.49662e+08
    - Total BytesReceived:  5.28681e+07
    - Total PacketsSent:    146154
    - Total PacketsReceived:        408896
    - Average End-to-End Delay:     32.683
    */
    /* TTL = 10
    - Packets sent:         139
    - Packets delivered:    64
    - Delivery percentage:  46.0432%
    - Total BytesSent:      1.65065e+08
    - Total BytesReceived:  5.64234e+07
    - Total PacketsSent:    161196
    - Total PacketsReceived:        449510
    - Average End-to-End Delay:     23.3195
    */
    /* TTL = 15
    - Packets sent:         139
    - Packets delivered:    64
    - Delivery percentage:  46.0432%
    - Total BytesSent:      1.79908e+08
    - Total BytesReceived:  5.64316e+07
    - Total PacketsSent:    175691
    - Total PacketsReceived:        468936
    - Average End-to-End Delay:     23.2717
    */
    /* TTL = 20
    - Packets sent:         139
    - Packets delivered:    58
    - Delivery percentage:  41.7266%
    - Total BytesSent:      1.71809e+08
    - Total BytesReceived:  5.74853e+07
    - Total PacketsSent:    167782
    - Total PacketsReceived:        445517
    - Average End-to-End Delay:     18.406
    */
    /* TTL = 25
    - Packets sent:         139
    - Packets delivered:    62
    - Delivery percentage:  44.6043%
    - Total BytesSent:      1.72773e+08
    - Total BytesReceived:  5.84458e+07
    - Total PacketsSent:    168724
    - Total PacketsReceived:        465696
    - Average End-to-End Delay:     12.66
    */
    ...
    AnimationInterface anim("epidemic.xml");
